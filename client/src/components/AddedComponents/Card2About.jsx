...
export default function Card2About() {
      ...
      <div className="grid place-items-center max-h-full max-w-[100vw] sm:mb-6 mb-28 pb-36 pt-20 sm:pt-8 mx-auto font-[sans-serif]">
        ...
        <div className="md:col-span-1  z-20 mt-24">
            <div className="mb-12 sm:max-w-[50vw]  sm:ml-6 md:ml-8   ">
              ...
              <h2 className=" shadow-2xl shadow-black text-white  w-fit text-3xl mb-10 px-10 py-6 bg-[#3A5A40] rounded-lg font-extrabold">
              L’OBJECTIF DE SOCIETE
              </h2>
                </div>
              <p className='text-justify font-sans  text-xl leading-10'> 
  ...
  <img
    ...
    alt="Profile"
  />
  <div className='-ml-64 bg-[#3A5A40] w-72 h-[550px] rounded-l-2xl'></div>
</div>
        </div>
      </div>
    </div>
